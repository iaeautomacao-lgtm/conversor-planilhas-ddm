...
class MultivixTransformer(BaseTransformer):
    def __init__(self):
        super().__init__("multivix", "MULTIVIX")
    ...
    def transform(self, raw_rows: list, headers: list) -> list:
        ...
        for row in raw_rows:
            tel1 = self.get_value(row, ['TELEFONE 1', 'TELEFONE1', 'TELEFONE', 'FONE1'], headers_norm)
            tel2 = self.get_value(row, ['TELEFONE 2', 'TELEFONE2', 'CELULAR', 'FONE2'], headers_norm)
